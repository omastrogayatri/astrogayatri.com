...
# Loop to print the key and values
    ...
    #Together AI call
    TOGETHER_API_KEY = "tgp_v1_CuuIqszXEvcAD0jNBncKPXDgyKEpcqlEC2xf4utHL2U"
...
#def generate_kundali_from_api(name, dob, time, location, eph_data):
    ...
    Please include Detailed Janm Kundali(within 1500 tokens) with vedic astrology Rashi, Ascendant, each planetary effects, overall 
