...
prompt = f"""
    Donot include any reasoning steps or thoughts, Generate a short 4 lines essay on dogs , do not include chain of thought or think in the output. I just need clean essay in the output
    """
